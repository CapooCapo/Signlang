...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'signlang'),
        'USER': os.getenv('DB_USER', 'signuser'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'signpass'),
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'SignLang <noreply@signlang.com>')
FRONTEND_URL = os.getenv('FRONTEND_URL', 'http://localhost:4200')

# ML Service Configuration
ML_SERVICE_URL = os.getenv('ML_SERVICE_URL', 'http://ml:9000')
